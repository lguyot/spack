...
class Mvdtool(CMakePackage):
    ...
    version('2.3.3', tag='v2.3.3', get_full_repo=False, submodules=True)
    version('2.3.2', tag='v2.3.2', get_full_repo=False, submodules=True)
    version('2.3.1', tag='v2.3.1', get_full_repo=False, submodules=True)
    version('2.3.0', tag='v2.3.0', get_full_repo=False, submodules=True)
    version('2.2.1', tag='v2.2.1', get_full_repo=False, submodules=True)
    version('2.2.0', tag='v2.2.0', get_full_repo=False, submodules=True)
    version('2.1.0', tag='v2.1.0', get_full_repo=False, submodules=True)
    version('2.0.0', tag='v2.0.0', get_full_repo=False, submodules=True)
